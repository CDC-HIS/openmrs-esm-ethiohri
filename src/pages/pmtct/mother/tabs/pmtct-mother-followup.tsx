...
import {
  MRN_NULL_WARNING,
  PMTCT_MOTHER_FOLLOWUP_ENCOUNTER_TYPE,
} from "../../../../constants";
...
const PMTCTMotherFollowup: React.FC<{ patientUuid: string }> = ({
  patientUuid,
}) => {
  ...
  return (
    <>
      <EncounterList
        ...
        encounterType={PMTCT_MOTHER_FOLLOWUP_ENCOUNTER_TYPE}
        formList={[{ name: "PMTCT Mother Inital Registration" }]}
        columns={columns}
        description="Mother's Followup"
        headerTitle="Mother's Followup"
        launchOptions={{
          displayText: "Add",
...
export default PMTCTMotherFollowup;
