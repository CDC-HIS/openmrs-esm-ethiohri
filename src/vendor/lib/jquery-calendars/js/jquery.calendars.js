...
$.calendars.newDate(1379, 10, 12, 'persian') */
    newDate: function (year, month, day, calendar, language) {
      calendar =
        (typeof year !== "undefined" && year !== null && year.year
          ? year.calendar()
    ...
    substituteChineseDigits: function (digits, powers) {
      return function (value) {
        ...
        while (value > 0) {
          var units = value % 10;
          localNumber =
            (units === 0 ? "" : digits[units] + powers[power]) + localNumber;
          power++;
...
date.newDate(2001, 1, 1) */
    newDate: function (year, month, day) {
      return this._calendar.newDate(
        typeof year === "undefined" || year === null ? this : year,
        month,
        day
      );
    },
...
var info = calendar.extraInfo(2014, 1, 26) */
    ...
    _add: function (date, offset, period) {
      ...
      if (period === "d" || period === "w") {
        var jd =
          date.toJD() + offset * (period === "w" ? this.daysInWeek() : 1);
