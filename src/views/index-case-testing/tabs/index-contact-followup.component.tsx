...
const columns = [
  {
    ...
    getValue: (encounter) => {
      const elicitedDate = getData(
        encounter,
        "58abd286-8f57-4717-aa41-efd8e93d5902",
        true,
      );
  ...
  },
  {
    ...
    getValue: (encounter) => {
      const firstName = getData(
        encounter,
        "166102AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
      );
      const fatherName = getData(
        encounter,
        "166574AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
      );
      const lastName = getData(
        encounter,
  ...
  },
  {
    ...
    getValue: (encounter) =>
      getData(encounter, "a7d17e7a-a8b2-49b5-84f1-aade1277b658"),
  },
  {
    key: "hivTestDate",
    header: "HIV test date",
    getValue: (encounter) => {
      const testDate = getData(
        encounter,
  ...
  },
  {
    ...
    getValue: (encounter) =>
      getData(encounter, "2e770be1-7397-4684-bea6-6632c23b00d7"),
  },
  {
    key: "actions",
    header: "Actions",
...
const IndexContactFollowup = ({ patientUuid, isICTOfferSaved }) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setHasAcceptedICT(
        acceptedValue?.valueCodeableConcept?.coding?.[0]?.code ===
          yesConceptUUID,
      );
    })();
